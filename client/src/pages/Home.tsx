...
const IMAGE_CONFIG = {
  logo: "/manus-storage/mpc-logo_21a7f2c3.png",
...
const navItems = [
  ["হোম", "#home"], ["সেবা", "#services"], ["চিকিৎসা", "#process"],
  ["আমাদের সম্পর্কে", "#therapist"], ["কেন আমরা", "#services"], ["যোগাযোগ", "#contact"],
];
...
const processSteps = [["০১", "সমস্যা জানান", "আপনার সমস্যা ও প্রয়োজনের কথা আমাদের জানান।"], ["০২", "প্রাথমিক মূল্যায়ন", "আপনার শারীরিক অবস্থার প্রাথমিক মূল্যায়ন করা হয়।"], ["০৩", "ব্যক্তিগত চিকিৎসা পরিকল্পনা", "প্রয়োজন অনুযায়ী ফিজিওথেরাপি ও ব্যায়ামভিত্তিক পরিকল্পনা।"], ["০৪", "স্বাভাবিক জীবনে ফেরা", "অগ্রগতি অনুযায়ী পরামর্শ ও ধীরে ধীরে চলাফেরায় সহায়তা।"]];
const faqs = [
  ...
  return <div className="notebook-site min-h-screen overflow-x-hidden bg-linen text-ink">
    <header className="fixed inset-x-0 top-0 z-50 border-b border-ink/10 bg-linen/92 backdrop-blur-md">
      <div className="container flex h-[70px] items-center justify-between gap-4">
        <a href="#home" className="brand-lockup" aria-label="মডার্ন ফিজিওথেরাপি সেন্টার, হোম"><span className="official-logo"><img src={IMAGE_CONFIG.logo} alt="মডার্ন ফিজিওথেরাপি সেন্টারের অফিসিয়াল লোগো" /></span><span><strong>মডার্ন ফিজিওথেরাপি</strong><small>সেন্টার · মুক্তাগাছা</small></span></a>
